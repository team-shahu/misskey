...
export declare function scrollInContainer(el: HTMLElement, options: ScrollToOptions | undefined): void;
...
export declare function isHeadVisible(el: HTMLElement, tolerance?: number): boolean;
export declare function isTailVisible(el: HTMLElement, tolerance?: number, container?: HTMLElement | null): boolean;
