...
>
	...
	<article :class="$style.note" @contextmenu.stop="onContextmenu">
			...
			<div :class="$style.noteHeaderBody">
				<div>
					...
					<div :class="$style.noteHeaderInfo">
						...
						<span v-else-if="appearNote.visibility !== 'public'" style="margin-left: 0.5em;" :title="i18n.ts._visibility[appearNote.visibility]">
		...
		<footer>
			...
			<button v-if="appearNote.myReaction == null && prefer.s.showLikeButton" ref="heartReactButton" v-tooltip="i18n.ts.like" :class="$style.noteFooterButton" class="_button" @mousedown="heartReact()">
